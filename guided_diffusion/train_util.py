...
class TrainLoop:
    def __init__(
        ...
        *,
        ...
        self.opt = AdamW(self.mp_trainer_Restoration.master_params, lr=self.lr, weight_decay=self.weight_decay)
    ...
    def forward_backward(self, batch_degrad, batch_gt):
        self.mp_trainer_Restoration.train()
        self.ddp_model.eval()
        ...
        for i in range(0, batch_degrad.shape[0], self.microbatch):
            ...
            losses, output = self.diffusion.training_losses(
                self.mp_trainer_Restoration.model,
                self.ddp_model,
                micro_degrad,
                micro_gt,
                t,
            ...
            self.mp_trainer_Restoration.backward(loss)
